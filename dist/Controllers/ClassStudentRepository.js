...
const ClassStudentController = (app) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.post("/getTblClassStudents", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const class_pk = req.body.class_pk;
        res.json(yield ClassStudentRepository_1.default.getTblClassStudents(class_pk));
    }));
    router.post("/enrollStudentClass", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const payload = req.body;
        res.json(yield ClassStudentRepository_1.default.enrollClassStudent(payload, req.user_id));
    }));
    router.post("/blockStudentClass", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.post("/reenrollStudentClass", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const class_stud_pk = req.body.class_stud_pk;
